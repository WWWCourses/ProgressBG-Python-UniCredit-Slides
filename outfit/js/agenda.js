...
function setThemeURL(){
    // wrap H3 text into link, with href == section.id path
        ...
        // <h3><a title="slides" href="/ProgressBG-Python-UniCredit-Slides/pages/themes/__themeTitle__/__themeTitle__.html">__themeTitle__</a></h3>
    ...
    for (let i = 0, len = themes.length; i < len ; i++){
        ...
        aNode.href = `/ProgressBG-Python-UniCredit-Slides/pages/themes/${themeTitle}/${themeTitle}.html`;
